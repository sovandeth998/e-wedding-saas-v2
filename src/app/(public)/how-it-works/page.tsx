...
const steps = [
  ...
  },
  {
    ...
    description: "ជ្រើសរើសពុម្ព និងបំពេញព័ត៌មានរោងពិធីរបស់អ្នក រូបថត និងតន្ត្រី។",
  },
  {
    icon: Eye,
    step: "៣",
...
const faqs = [
  { q: "តើវាពិតជាឥតគិតថ្លៃទេ?", a: "បាទ/ចាស! កញ្ចប់ឥតគិតថ្លៃរួមបញ្ចូលពុម្ពធម្មតា និងមុខងារ基础។ អ្នកអាច upgrade បានពេលណាមួយ។" },
  ...
  { q: "តើខ្ញុំអាចផ្លាស់ប្ដូរពុម្ពបានទេ?", a: "បាទ/ចាស! អ្នកអាចផ្លាស់ប្ដូរពុម្ពបានគ្រប់ពេលពី Dashboard។" },
