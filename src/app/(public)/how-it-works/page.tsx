...
const steps = [
  ...
  },
  {
    icon: Palette,
    step: "២",
    title: "ជ្រើសរើស និងប្តូរតាមបំណង",
...
const faqs = [
  { q: "តើវាពិតជាឥតគិតថ្លៃទេ?", a: "បាទ/ចាស! កញ្ចប់ឥតគិតថ្លៃរួមបញ្ចូលធៀបគំរូធម្មតា និងមុខងារមូលដ្ឋាន។ អ្នកអាច upgrade បានពេលណាមួយ។" },
  ...
  { q: "តើខ្ញុំអាចផ្លាស់ប្តូរធៀបគំរូបានទេ?", a: "បាទ/ចាស! អ្នកអាចផ្លាស់ប្តូរធៀបគំរូបានគ្រប់ពេលពី Dashboard។" },
