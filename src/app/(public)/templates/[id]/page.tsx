...
> = {
  "1": {
    ...
    category: "modern",
    isPremium: false,
    description: "ធៀបគំរូរ៉ូមែនទិចជាមួយពណ៌មាសផ្កាឈូក សមស្របសម្រាប់គូស្នេហ៍ដែលចូលចិត្តរចនាបែបថ្មីនិងទាន់សម័យ។",
  ...
  "2": {
    ...
    category: "luxury",
    isPremium: true,
    description: "ប្រធានបទមាសប្រណិតសម្រាប់រោងពិធីប្រណិត ផ្ដល់នូវបទពិសោធន៍ពិសេសដល់ភ្ញៀវ។",
  ...
  "5": {
    ...
    category: "luxury",
    isPremium: true,
    description: "រចនាបែបរាជវាំងប្រណិត ផ្ដល់នូវអារម្មណ៍ភាពអស្ចារ្យនិងតម្លៃខ្ពស់។",
  ...
  "7": {
    ...
    category: "classic",
    isPremium: false,
    description: "រចនាបែបប្រពៃណីជាមួយផ្កាឈូកពណ៌ស ផ្ដល់នូវភាពទន់ភ្លន់និងរ៉ូមែនទិច។",
  ...
  "9": {
    ...
    category: "modern",
    isPremium: false,
    description: "រចនាបែបធម្មជាតិជាមួយទឹកជ្រោះ ផ្ដល់នូវភាពស្រស់ស្អាតនិងត្រជាក់។",
