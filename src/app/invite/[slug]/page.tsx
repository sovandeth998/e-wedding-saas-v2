...
function InvitationContent() {
  ...
  const T: Record<string, {
    ...
    "1":  { bg: "linear-gradient(135deg, #1a1a2e, #16213e, #0f3460)", bgMain: "linear-gradient(180deg, #1a1a2e, #0f1a35)", cardFrom: "#1e2a4a", cardTo: "#0d1b3e", textPri: "#fef3c7", textSec: "rgba(254,243,199,0.6)", textMut: "rgba(254,243,199,0.4)", accent: "#eab308", accentFill: "rgba(234,179,8,0.2)", accentBg: "rgba(234,179,8,0.05)", btnFrom: "#ca8a04", btnTo: "#a16207" },
